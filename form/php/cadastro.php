...
if ($linha['root'] == 'sim'){
        ...
        if ($total <= 0){
            ...
            elseif ($exibe['logi'] == $logi) {
                    ...
                    $senh = MD5($_POST['senh']);
                    $query = "INSERT INTO USUARIOS (login,senha,root) VALUES ('$logi','$senh','$root');";
      ...
      */
      ...
      echo"<script language='javascript' type='text/javascript'>alert('O seu usuário não tem permissão de acesso para criar novos admins!');window.location.href='cadastroAdmin.php';</script>";
